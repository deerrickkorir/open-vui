...
console.log(`Building open-vui library${isDev ? " (dev mode)" : ""}...`)
...
if (existsSync(join(rootDir, "scripts", "vue-plugin.ts"))) {
  copyFileSync(join(rootDir, "scripts", "vue-plugin.ts"), join(distDir, "scripts", "vue-plugin.ts"))
}
...
if (existsSync(readmePath)) {
  ...
  console.warn("Warning: README.md not found in open-vui package")
}
